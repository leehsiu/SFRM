function  rotm  = eul2rotm_server( eul, sequence )
%EUL2ROTM_SERVER Summary of this function goes here
%   Detailed explanation goes here
    ...
    s_1 = sin(eul(1)); % theta_z or theta_z1
    c_1 = cos(eul(1));
    s_2 = sin(eul(2)); % theta_y
    c_2 = cos(eul(2));
    s_3 = sin(eul(3)); % theta_x or theta_z2
    c_3 = cos(eul(3));
