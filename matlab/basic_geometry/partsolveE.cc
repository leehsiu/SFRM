...
void mexFunction(int nlhs, mxArray *plhs[],
   ...
   if (nlhs > 1) 
      ...
      dims[1] = 3; 
      dims[2] = 5;
      const mwSize outDims[3] = {3,3,5};     
      plhs[1] = mxCreateNumericArray(3, outDims, mxDOUBLE_CLASS, mxREAL);
   ...
   if (nlhs > 2) 
      ...
      dims[0] = 1;
      dims[1] = 11;
      const mwSize outDims[2] = {1,11};   
      plhs[2] = mxCreateNumericArray(2, outDims, mxDOUBLE_CLASS, mxREAL);
